 ...
 * Exa for search; fetch_url for direct HTTPS doc pages.
 */
...
export async function webSearchExa(
  ...
  if (!key) {
    return {
      ...
      query,
      error:
        "web_search requires EXA_API_KEY (or SLOPCONTROL_EXA_API_KEY). Set it in the SlopControl server environment and restart. See README “Internet research”.",
    };
  }
