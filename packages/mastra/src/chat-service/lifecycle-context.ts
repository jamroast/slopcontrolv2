...
- get_ask / get_agent / get_development_report / design_loop_get / plan_loop_get require the id from the matching list_* tool (get_ask and plan_loop_get may omit askId/loopId to use this chat's latched session). Never call get_agent / loop gets empty.
