...
export function ensurePlatformLearnings(projectRoot: string): void {
  ...
  promoteLearning(projectRoot, {
    ...
    lesson: [
      ...
      "Same claim-vs-proof pattern applies elsewhere (chat stream / Ollama routing, engagement fill+submit, DDL migrate, menubar ThemeToggle) — greps for `export function ThemeToggle` alone are insufficient; prove `<ThemeToggle` in shell menubar and Menubar/JampressMenubar in playground App **or** product layout shell (marketing/portal).",
